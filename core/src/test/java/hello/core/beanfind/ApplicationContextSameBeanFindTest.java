...
public class ApplicationContextSameBeanFindTest {
    ...
    @Test
    @DisplayName("타입으로 조회했을때, 같은 타입이 둘 이상 있으면, 중복 오류가 발생한다.")
    ...
    void findAllBeanByType() {
        ...
        System.out.println("beansOfType = " + beansOfType); //MemberRepository
        assertThat(beansOfType.size()).isEqualTo(2);
    }
    //ApplicationContectSameBeanFindTest에서만 사용한 클래스
    @Configuration
